...
export default function MasterclassOptIn() {
  ...
  const onSubmit = async (data: OptInValues) => {
    ...
    try {
      ...
      navigate("/fb-ads-course?flow=dual");
    } catch {
      navigate("/fb-ads-course?flow=dual");
    } finally {
    ...
    <div className="min-h-screen" style={{ background: "var(--titan-background)" }}>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12">
        <div className="rounded-2xl border border-[var(--titan-border)] bg-white p-8">
          ...
          <p className="leading-relaxed mb-4" style={{ color: "var(--titan-text-secondary)" }}>
            Dr. Emeka is a Physical Medicine & Rehab physician based in Miami, Florida, who
            has grown to over 180,000 followers sharing insights on healthcare, business,
            and marketing.
          </p>
          <p className="leading-relaxed mb-4" style={{ color: "var(--titan-text-secondary)" }}>
            He took the skills he learned building his own health coaching business and now
            uses them to help other healthcare practitioners grow their practices. He runs
            the Health Pro CEO Academy, a community packed with resources and training
            covering everything he wishes he had known when starting out.
          </p>
          <p className="leading-relaxed" style={{ color: "var(--titan-text-secondary)" }}>
            His clients have generated over $1.5M in revenue in 2025 using the exact
            strategies taught in this free training.
          </p>
        </div>
      </section>
